...
//function can be function but we can use it as an object 
...
createUser.prototype.increment= function(){  //injecting function to it's prototype
    this.score++
}
...
const tea =  createUser("tea",250) //without new keyword it wont work because we didn;t have this method by default
